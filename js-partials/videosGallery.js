...
document.addEventListener("DOMContentLoaded", () => {
  ...
  container.innerHTML =
    "<h2 class='videos-grid-heading'>Галерея відео, згенерованих штучним інтелектом</h2><p class='videos-grid-paragraph'>На жаль, не кожен вірш у виконанні В. Симоненка було записано та збережено. Проте сучасні технології дозволяють створити декламацію вірша, ніби сам поет розповідає його.</p>";
